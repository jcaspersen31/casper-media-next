  ...
  return (
    <div ref={ref} style={{ position:"relative" }}>
      ...
      {open && filtered.length > 0 && (
        <div style={{ position:"absolute", top:"100%", left:0, right:0, background:"#111", border:"1px solid #2a2a2a", borderRadius:2, zIndex:100, maxHeight:280, overflowY:"auto", marginTop:2 }}>
          {filtered.map(p => (
            <div key={p.id} onClick={() => select(p)}
              style={{ padding:"9px 12px", cursor:"pointer", borderBottom:"1px solid #1a1a1a", transition:"background 0.1s" }}
...
export default function DealsPage() {
  ...
  return (
    <div>
      ...
      {/* Add deal form */}
      {adding && (
        <div style={{ background:"#111", border:`1px solid ${GOLD}`, borderRadius:3, padding:"1.5rem", marginBottom:20 }}>
