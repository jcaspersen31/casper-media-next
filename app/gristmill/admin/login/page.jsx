  ...
  return (
    <div style={{ minHeight:"100vh", background:"#080808", display:"flex", alignItems:"center", justifyContent:"center" }}>
      ...
      <div style={{ background:"var(--bg-card)", border:`1px solid ${GOLD}`, borderRadius:3, padding:"2.5rem", width:320, textAlign:"center" }}>
        ...
        <a href="/gristmill" style={{ display:"block", marginTop:16, fontFamily:"'Oswald',sans-serif", fontSize:10, color:"var(--text-dim)", letterSpacing:"0.1em", textDecoration:"none" }}>← BACK TO SITE</a>
      </div>
    </div>
  );
}
