...
export default function AdminLoginPage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        router.replace("/gristmill/admin/reservations");
      } else {
    ...
    <div style={{ minHeight:"100vh", background:"#080808", display:"flex", alignItems:"center", justifyContent:"center" }}>
      ...
      <div style={{ background:"#111", border:`1px solid ${GOLD}`, borderRadius:3, padding:"2.5rem", width:320, textAlign:"center" }}>
        ...
        <input
          ...
          style={{ width:"100%", background:"#0a0a0a", border:`1px solid ${err ? "#c0392b" : "#1e1e1e"}`, color:"#e8e0d0", padding:"10px 14px", borderRadius:2, fontFamily:"Georgia,serif", fontSize:14, outline:"none", boxSizing:"border-box", marginBottom: err ? 8 : 14 }}
        />
